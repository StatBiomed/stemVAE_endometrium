...
def main():
    ...
    # supervise_vae supervise_vae_noclfdecoder  supervise_vae_regressionclfdecoder  supervise_vae_regressionclfdecoder_of_sublatentspace
    ...
    # -----------------------------------------Preprocess data------------------------------------------------------
    cell_sample_num = 6000
    if len(sc_expression_df) > cell_sample_num:
        sc_expression_df = sc_expression_df.sample(n=cell_sample_num, random_state=0)
        cell_time = cell_time.loc[sc_expression_df.index]
        _logger.info("random select cell: {}".format(cell_sample_num))
