...
@File    ：VAE_fromDandan_testRifDonor_dataAugmentation.py
@IDE     ：PyCharm 
@Author  ：awa121
...
2023-09-25 14:55:43
downsample 18donor+ downsample donor
data augmentataion on 18 donor: downsample 1/10 and 1/3
then test on downsampled-rif donor and rif donor
...
def main():
    ...
    for fold in range(len(test_donor_list)):
        ...
        sc_expression_df, cell_time = preprocessData_and_dropout_some_donor_or_gene(data_golbal_path, sc_data_file_csv,
                                                                                    ...
                                                                                    augmentation_on_trainData_bool=True,
