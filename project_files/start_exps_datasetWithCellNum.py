...
nohup python -u start_exps_datasetWithCellNum.py > logs/start_exps_datasetWithCellNum_newAnno0717_Gene0720_18donor_2type_plot_random6000Cell.log 2>&1 &
...
def main():
    ...
    result_save_path = "230728_newAnno0717_Gene0720_18donor_2type_plot_random6000Cell"
    ...
    epoch_num = 100
    python_file = "../VAE_fromDandan_testOnOneDonor_withCellTypeSameCellNumber.py"
