...
@File    ：start_exps_trainOn18Donor_testOnRIF.py
@IDE     ：PyCharm 
@Author  ：awa121
@Date    ：2023/7/16 19:42

nohup python -u start_exps_trainOn18Donor_testOnRIF.py > logs/start_exps_trainOn18Donor_testOnRIF_GeneVP_230728_newAnno0717_GeneImmunity0720_trainOn18Donor_testOnRIF.log 2>&1 &
nohup python -u start_exps_trainOn18Donor_testOnRIF.py > logs/start_exps_trainOn18Donor_testOnRIF_GeneVP_230728_newAnno0717_Gene0720_trainOn18Donor_testOnRIF.log 2>&1 &
nohup python -u start_exps_trainOn18Donor_testOnRIF.py > logs/start_exps_trainOn18Donor_testOnRIF_GeneVP_230728_newAnno0717_GeneVP0721_trainOn18Donor_testOnRIF.log 2>&1 &
"""
...
def main():
    ...
    # result_save_path = "230728_newAnno0717_GeneImmunity0720_trainOn18Donor_testOnRIF"
    ...
    result_save_path = "230728_newAnno0717_Gene0720_trainOn18Donor_testOnRIF"

    # dataset_list = [
    #     # "preprocess_02_major_Anno0717_GeneVP0721",
    ...
    # result_save_path = "230728_newAnno0717_GeneVP0721_trainOn18Donor_testOnRIF"
    ...
    # time_type_list_rf = ["log2", "0to1", "neg1to1", "sigmoid", "logit"]
