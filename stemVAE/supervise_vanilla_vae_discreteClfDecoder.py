...
class SuperviseVanillaVAE_discreteClfDecoder(BaseVAE):
    ...
    def __init__(self,
                 ...
                 **kwargs) -> None:
        super(SuperviseVanillaVAE_discreteClfDecoder, self).__init__()
        ...
        self.clf_input = nn.Linear(self.latent_dim, hidden_dims[0])  # hidden_dims[0]=64
